SJMTig::Application.routes.draw do
  resources :offices

  resources :wall_plates

  resources :port_panels

  resources :panels

  resources :panel_models

  resources :panel_brands
  ...
  resources :oid_models

  resources :oids

  resources :port_models
